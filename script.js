...
window.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.carousel-card-images').forEach(carouselContainer => {
        ...
        const prevCardBtn = carouselContainer.nextElementSibling ? carouselContainer.nextElementSibling.querySelector('.prev-card-img') : null;
        const nextCardBtn = carouselContainer.nextElementSibling ? carouselContainer.nextElementSibling.querySelector('.next-card-img') : null;
        ...
        if (nextCardBtn) {
            nextImageIndex = (currentImageIndex < images.length - 1) ? currentImageIndex + 1 : 0;
            updateCardCarousel();
        });
        }
